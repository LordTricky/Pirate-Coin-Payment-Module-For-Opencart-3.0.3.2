...
$sqlpp="UPDATE `oc_currency` SET `value` = '$gbppv' WHERE `oc_currency`.`currency_id` = 4;"; //Change currency_id 4 to match the id of your pirate currency in your database
